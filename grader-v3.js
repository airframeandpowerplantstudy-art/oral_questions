...
function grade(q,answer){
 ...
 return {
  source:'jeppesen-local-v5',version:'5.0',level,passed,count,total:concepts.length,required:b.required,concepts,orderOK,
...
global.FAA_GRADER={version:'5.0-jeppesen-local',normalize,tokens,grade,blueprint,matchGroup,manualCount:Object.keys(MANUAL).length};
})(window);
